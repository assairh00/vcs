...
function buyButtonClicked() {
    ...
    for (var i = 0; i < cartBoxes.length; i++) {
        ...
        var sugarOption = cartBox.getElementsByClassName("cart-sugar-option")[0].innerText.replace('Size: ', ''); // Get sugar option
...
function updatePrice(selectElement) {
    ...
    var productTitle = selectElement.parentElement.getElementsByClassName('product-title')[0].innerText;
