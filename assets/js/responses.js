function getBotResponse(input) {
    ...
    if (input == "hello") {
        ...
        return "Here's our menu: <br /><br /> Americano - Hot Espresso   - ₱45.00 <br /> Caffe Latte - Steamed Milk   - ₱65.00 <br /> Salted Caramel Espresso   - ₱75.00 <br /> Cafe Mocha Espresso   - ₱75.00 <br /> Spanish Latte Espresso   - ₱75.00 ";
    } else if (input == "about") {
